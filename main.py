    ...
    for song in os.listdir(songs_path):
        ...
        for file in os.listdir(os.path.join(songs_path,song)):
            ...
            if ".png" in file or ".jpg" in file:
                ...
                if ext == '.png':
                    os.replace(os.path.join(song_location,f'{png_image_name}.png'),os.path.join(song_location, old_image_name))
                else:
                    os.replace(os.path.join(song_location,f'{jpg_image_name}.png'),os.path.join(song_location, old_image_name))
